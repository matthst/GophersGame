...
func (gb *Gameboy) execNextInstr() int {
	...
	case 0x01:
		return gb.loadI16(&gb.BC)
	case 0x11:
		return gb.loadI16(&gb.DE)
	case 0x21:
		return gb.loadI16(&gb.HL)
	case 0x31:
		return gb.loadI16SP()
	case 0x02:
		return gb.storeR8(gb.AF[1], getWord(&gb.BC))
	case 0x12:
		return gb.storeR8(gb.AF[1], getWord(&gb.DE))
	case 0x22:
		return gb.storeR8(gb.AF[1], getWordInc(&gb.HL))
	case 0x32:
		return gb.storeR8(gb.AF[1], getWordDec(&gb.HL))
	case 0x03:
		return incR16(&gb.BC)
	case 0x13:
		return incR16(&gb.DE)
	...
	case 0x33:
		return gb.incSP()
	case 0x04:
		return gb.incR8(&gb.BC[1])
	case 0x14:
		return gb.incR8(&gb.DE[1])
	case 0x24:
		return gb.incR8(&gb.HL[1])
	case 0x34:
		return gb.incM8(getWord(&gb.HL))
	case 0x05:
		return gb.decR8(&gb.BC[1])
	case 0x15:
		return gb.decR8(&gb.DE[1])
	case 0x25:
		return gb.decR8(&gb.HL[1])
	case 0x35:
		return gb.decM8(getWord(&gb.HL))
	case 0x06:
		return gb.loadI8(&gb.BC[1])
	case 0x16:
		return gb.loadI8(&gb.DE[1])
	case 0x26:
		return gb.loadI8(&gb.HL[1])
	case 0x36:
		return gb.storeI8(&gb.HL)
	case 0x07:
	...
	case 0x1A:
		return gb.loadR8(&gb.AF[1], getWord(&gb.DE))
	case 0x2A:
		return gb.loadR8(&gb.AF[1], getWordInc(&gb.HL))
	case 0x3A:
		return gb.loadR8(&gb.AF[1], getWordDec(&gb.HL))
	case 0x0B:
		return decR16(&gb.BC)
	case 0x1B:
		return decR16(&gb.DE)
	...
	case 0x3B:
		return gb.decSP()
	case 0x0C:
		return gb.incR8(&gb.BC[0])
	case 0x1C:
		return gb.incR8(&gb.DE[0])
	case 0x2C:
		return gb.incR8(&gb.HL[0])
	case 0x3C:
		return gb.incR8(&gb.AF[1])
	case 0x0D:
		return gb.decR8(&gb.BC[0])
	case 0x1D:
		return gb.decR8(&gb.DE[0])
	case 0x2D:
		return gb.decR8(&gb.HL[0])
	case 0x3D:
		return gb.decR8(&gb.AF[1])
	case 0x0E:
		return gb.loadI8(&gb.BC[0])
	case 0x1E:
		return gb.loadI8(&gb.DE[0])
	case 0x2E:
		return gb.loadI8(&gb.HL[0])
	case 0x3E:
		return gb.loadI8(&gb.AF[1])
	case 0x0F:
		return gb.rotateRightCircularA()
	case 0x1F:
		return gb.rotateRightA()
	case 0x2F:
		return complementR8(&gb.AF[1])
	case 0x3F:
		return gb.setCarryFlag(!gb.getCFlag())
	case 0x40:
		return loadR8R8(&gb.BC[1], &gb.BC[1])
	case 0x50:
		return loadR8R8(&gb.DE[1], &gb.BC[1])
	case 0x60:
		return loadR8R8(&gb.HL[1], &gb.BC[1])
	case 0x70:
		return gb.storeR8(gb.BC[1], getWord(&gb.HL))
	case 0x41:
		return loadR8R8(&gb.BC[1], &gb.BC[0])
	case 0x51:
		return loadR8R8(&gb.DE[1], &gb.BC[0])
	case 0x61:
		return loadR8R8(&gb.HL[1], &gb.BC[0])
	case 0x71:
		return gb.storeR8(gb.BC[0], getWord(&gb.HL))
	case 0x42:
		return loadR8R8(&gb.BC[1], &gb.DE[1])
	case 0x52:
		return loadR8R8(&gb.DE[1], &gb.DE[1])
	case 0x62:
		return loadR8R8(&gb.HL[1], &gb.DE[1])
	case 0x72:
		return gb.storeR8(gb.DE[1], getWord(&gb.HL))
	case 0x43:
		return loadR8R8(&gb.BC[1], &gb.DE[0])
	case 0x53:
		return loadR8R8(&gb.DE[1], &gb.DE[0])
	case 0x63:
		return loadR8R8(&gb.HL[1], &gb.DE[0])
	case 0x73:
		return gb.storeR8(gb.DE[0], getWord(&gb.HL))
	case 0x44:
		return loadR8R8(&gb.BC[1], &gb.HL[1])
	case 0x54:
		return loadR8R8(&gb.DE[1], &gb.HL[1])
	case 0x64:
		return loadR8R8(&gb.HL[1], &gb.HL[1])
	case 0x74:
		return gb.storeR8(gb.HL[1], getWord(&gb.HL))
	case 0x45:
		return loadR8R8(&gb.BC[1], &gb.HL[0])
	case 0x55:
		return loadR8R8(&gb.DE[1], &gb.HL[0])
	case 0x65:
		return loadR8R8(&gb.HL[1], &gb.HL[0])
	case 0x75:
		return gb.storeR8(gb.HL[0], getWord(&gb.HL))
	case 0x46:
		return gb.loadR8(&gb.BC[1], getWord(&gb.HL))
	case 0x56:
		return gb.loadR8(&gb.DE[1], getWord(&gb.HL))
	case 0x66:
		return gb.loadR8(&gb.HL[1], getWord(&gb.HL))
	case 0x76:
		return gb.halt()
	case 0x47:
		return loadR8R8(&gb.BC[1], &gb.AF[1])
	case 0x57:
		return loadR8R8(&gb.DE[1], &gb.AF[1])
	case 0x67:
		return loadR8R8(&gb.HL[1], &gb.AF[1])
	case 0x77:
		return gb.storeR8(gb.AF[1], getWord(&gb.HL))
	case 0x48:
		return loadR8R8(&gb.BC[0], &gb.BC[1])
	case 0x58:
		return loadR8R8(&gb.DE[0], &gb.BC[1])
	case 0x68:
		return loadR8R8(&gb.HL[0], &gb.BC[1])
	case 0x78:
		return loadR8R8(&gb.AF[1], &gb.BC[1])
	case 0x49:
		return loadR8R8(&gb.BC[0], &gb.BC[0])
	case 0x59:
		return loadR8R8(&gb.DE[0], &gb.BC[0])
	case 0x69:
		return loadR8R8(&gb.HL[0], &gb.BC[0])
	case 0x79:
		return loadR8R8(&gb.AF[1], &gb.BC[0])
	case 0x4A:
		return loadR8R8(&gb.BC[0], &gb.DE[1])
	case 0x5A:
		return loadR8R8(&gb.DE[0], &gb.DE[1])
	case 0x6A:
		return loadR8R8(&gb.HL[0], &gb.DE[1])
	case 0x7A:
		return loadR8R8(&gb.AF[1], &gb.DE[1])
	case 0x4B:
		return loadR8R8(&gb.BC[0], &gb.DE[0])
	case 0x5B:
		return loadR8R8(&gb.DE[0], &gb.DE[0])
	case 0x6B:
		return loadR8R8(&gb.HL[0], &gb.DE[0])
	case 0x7B:
		return loadR8R8(&gb.AF[1], &gb.DE[0])
	case 0x4C:
		return loadR8R8(&gb.BC[0], &gb.HL[1])
	case 0x5C:
		return loadR8R8(&gb.DE[0], &gb.HL[1])
	case 0x6C:
		return loadR8R8(&gb.HL[0], &gb.HL[1])
	case 0x7C:
		return loadR8R8(&gb.AF[1], &gb.HL[1])
	case 0x4D:
		return loadR8R8(&gb.BC[0], &gb.HL[0])
	case 0x5D:
		return loadR8R8(&gb.DE[0], &gb.HL[0])
	case 0x6D:
		return loadR8R8(&gb.HL[0], &gb.HL[0])
	case 0x7D:
		return loadR8R8(&gb.AF[1], &gb.HL[0])
	case 0x4E:
		return gb.loadR8(&gb.BC[0], getWord(&gb.HL))
	case 0x5E:
		return gb.loadR8(&gb.DE[0], getWord(&gb.HL))
	case 0x6E:
		return gb.loadR8(&gb.HL[0], getWord(&gb.HL))
	case 0x7E:
		return gb.loadR8(&gb.AF[1], getWord(&gb.HL))
	case 0x4F:
		return loadR8R8(&gb.BC[0], &gb.AF[1])
	case 0x5F:
		return loadR8R8(&gb.DE[0], &gb.AF[1])
	case 0x6F:
		return loadR8R8(&gb.HL[0], &gb.AF[1])
	case 0x7F:
		return loadR8R8(&gb.AF[1], &gb.AF[1])
	case 0x80:
		return gb.addR8(gb.BC[1])
	case 0x90:
		return gb.subR8(gb.BC[1])
	case 0xA0:
		return gb.andR8(gb.BC[1])
	case 0xB0:
		return gb.orR8(gb.BC[1])
	case 0x81:
		return gb.addR8(gb.BC[0])
	case 0x91:
		return gb.subR8(gb.BC[0])
	case 0xA1:
		return gb.andR8(gb.BC[0])
	case 0xB1:
		return gb.orR8(gb.BC[0])
	case 0x82:
		return gb.addR8(gb.DE[1])
	case 0x92:
		return gb.subR8(gb.DE[1])
	case 0xA2:
		return gb.andR8(gb.DE[1])
	case 0xB2:
		return gb.orR8(gb.DE[1])
	case 0x83:
		return gb.addR8(gb.DE[0])
	case 0x93:
		return gb.subR8(gb.DE[0])
	case 0xA3:
		return gb.andR8(gb.DE[0])
	case 0xB3:
		return gb.orR8(gb.DE[0])
	case 0x84:
		return gb.addR8(gb.HL[1])
	case 0x94:
		return gb.subR8(gb.HL[1])
	case 0xA4:
		return gb.andR8(gb.HL[1])
	case 0xB4:
		return gb.orR8(gb.HL[1])
	case 0x85:
		return gb.addR8(gb.HL[0])
	case 0x95:
		return gb.subR8(gb.HL[0])
	case 0xA5:
		return gb.andR8(gb.HL[0])
	case 0xB5:
		return gb.orR8(gb.HL[0])
	case 0x86:
	...
	case 0x87:
		return gb.addR8(gb.AF[1])
	case 0x97:
		return gb.subR8(gb.AF[1])
	case 0xA7:
		return gb.andR8(gb.AF[1])
	case 0xB7:
		return gb.orR8(gb.AF[1])
	case 0x88:
		return gb.adcR8(gb.BC[1])
	case 0x98:
		return gb.sbcR8(gb.BC[1])
	case 0xA8:
		return gb.xorR8(gb.BC[1])
	case 0xB8:
		return gb.cpR8(gb.BC[1])
	case 0x89:
		return gb.adcR8(gb.BC[0])
	case 0x99:
		return gb.sbcR8(gb.BC[0])
	case 0xA9:
		return gb.xorR8(gb.BC[0])
	case 0xB9:
		return gb.cpR8(gb.BC[0])
	case 0x8A:
		return gb.adcR8(gb.DE[1])
	case 0x9A:
		return gb.sbcR8(gb.DE[1])
	case 0xAA:
		return gb.xorR8(gb.DE[1])
	case 0xBA:
		return gb.cpR8(gb.DE[1])
	case 0x8B:
		return gb.adcR8(gb.DE[0])
	case 0x9B:
		return gb.sbcR8(gb.DE[0])
	case 0xAB:
		return gb.xorR8(gb.DE[0])
	case 0xBB:
		return gb.cpR8(gb.DE[0])
	case 0x8C:
		return gb.adcR8(gb.HL[1])
	case 0x9C:
		return gb.sbcR8(gb.HL[1])
	case 0xAC:
		return gb.xorR8(gb.HL[1])
	case 0xBC:
		return gb.cpR8(gb.HL[1])
	case 0x8D:
		return gb.adcR8(gb.HL[0])
	case 0x9D:
		return gb.sbcR8(gb.HL[0])
	case 0xAD:
		return gb.xorR8(gb.HL[0])
	case 0xBD:
		return gb.cpR8(gb.HL[0])
	case 0x8E:
	...
	case 0x8F:
		return gb.adcR8(gb.AF[1])
	case 0x9F:
		return gb.sbcR8(gb.AF[1])
	case 0xAF:
		return gb.xorR8(gb.AF[1])
	case 0xBF:
		return gb.cpR8(gb.AF[1])
	case 0xC0:
...
func (gb *Gameboy) loadAMI16() int {
	lo := gb.getImmediate()
	hi := gb.getImmediate()
	gb.AF[1] = gb.load(getWordFromBytes(hi, lo))
	return 4
}
...
func (gb *Gameboy) loadAC() int {
	adr := uint16(0xFF00) | uint16(gb.BC[0])
	gb.AF[1] = gb.load(adr)
	return 2
}
...
func (gb *Gameboy) storeAMI16() int {
	lo := gb.getImmediate()
	hi := gb.getImmediate()
	gb.write(gb.AF[1], getWordFromBytes(hi, lo))
	return 4
}
...
func (gb *Gameboy) push(reg *[2]uint8) int {
	gb.write(reg[1], gb.SP)
	gb.SP--
	gb.write(reg[0], gb.SP)
	gb.SP--
	return 4
}
...
func (gb *Gameboy) addSPS8HL() int {
	setWord(&gb.HL, gb.addSPS8Internal())
	return 3
}
...
func (gb *Gameboy) andR8(val uint8) int {
	gb.AF[1] &= val
	gb.setFlags(gb.AF[1] == 0, false, true, false)
	return 1
}
...
func (gb *Gameboy) orR8(val uint8) int {
	gb.AF[1] |= val
	gb.setFlags(gb.AF[1] == 0, false, false, false)
	return 1
}
...
func (gb *Gameboy) decimalAdjustA() int {
	if !gb.getNFlag() {
		if gb.getCFlag() || gb.AF[1] > 0x99 {
			gb.AF[1] += 0x000_0060
			gb.setCFlag(true)
		}
		if gb.getHFlag() || (gb.AF[1]&0x0f) > 0x09 {
			gb.AF[1] += 0x000_0006
		}
	} else {
		if gb.getCFlag() {
